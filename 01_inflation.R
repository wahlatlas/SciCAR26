...
###################################
# Beispiel Inflation, Quaderzugriff
###################################

# Recherche über die API, Statistiknummer (EVAS) bekannt
...
ggsave(paste("01_inflation_",month,year,".png",sep="_"), width=1920, height=1080, units="px")
